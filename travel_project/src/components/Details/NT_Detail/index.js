...
import Background from "../../Img/Destination/DetailNhaTrang.jpg"
...
class NT_Detail extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        this.props.firebase.blogs('nha_trang').child(this.id).once('value', snapshot => {
...
export default withFirebase(NT_Detail);
