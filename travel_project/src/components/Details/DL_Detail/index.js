...
import Background from "../../Img/Destination/DetailHaNoi.jpg"
...
class DL_Detail extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        this.props.firebase.blogs('da_lat').child(this.id).once('value', snapshot => {
...
export default withFirebase(DL_Detail);
